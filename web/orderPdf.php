   ...
   <div class="jumbotron">
	<form id="calculation_form" method="POST" action="index.php?r=site%2Fsamplepdf" target="_blank">	
		 <div class="total_price" style="width:100%;float:left;">
		 	<div class="page-header" style="float:left;">Общая стоимость заказа: <span id="price_value"><?= !empty($_POST["price_input"])?$_POST["price_input"]:"\"0\"" ?></span> беларусских рублей.</div>
		 	<div class="total_weight ">Общий вес, брутто: <span class="result" id="total_weight"><?= (!empty($_POST["weight_input"]))?$_POST["weight_input"]:"\"0\"" ?></span> кг.  </div>
				...
				<div class="cart_position">
					...
					<div class="calculation">
						...
						<div id="calc_right_half">
										...
										Стоимость: <span class="color_result result" id="result_color_<?= $cartItem->product_color_id ?>"><?= (!empty($_POST['price_color'][$cartItem->product_color_id]))?$_POST['price_color'][$cartItem->product_color_id]:"\"0\"" ?></span>  беларусских рублей.<br>
										Масса, брутто: <span class="weight_result result" id="result_weight_<?= $cartItem->product_color_id ?>"><?= (!empty($_POST['weight_color'][$cartItem->product_color_id]))?$_POST['weight_color'][$cartItem->product_color_id]:"\"0\"" ?></span> кг.</p>
