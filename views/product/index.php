        ...
        <?php foreach ($categories as $category): ?>
           <?php foreach ($products as $productItem): ?>
                <?php if (!strcmp($category->product_category_name,$productItem->product_category_name)): ?>
                    ...
                    <div class="product">
                        <a href="?ProductColorSearch%5Bproduct_subcategory_name%5D=<?php echo urlencode($productItem->product_product_name) ?>&r=productcolor%2Findex"><img src="<?= $productItem->product_product_image?>" alt="" width="100%">
