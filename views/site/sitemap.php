...
<div class="site-index">
   	<div class="jumbotron">
	    <div class="page-header"><span style="color:#858370"<b>КАРТА САЙТА</b></div>
		<div class="page-text">
			<p>
		...
		<ul id="primaryNav" class="col4">
			...
			<li><a href="#">Информация</a>
				<ul>
                    ...
                    <li><a href="index.php?r=site%2Fpublicoffer">Публичная оферна</a></li>
                    <li><a href="index.php?r=site%2Fprice">Каталог и прайс-лист</a></li>
                    <li><a href="index.php?r=product%2F3ds">Текстуры камня 3DS</a></li>

				</ul>
			</li>
			<li><a href="index.php?r=stores%2Findex">Где купить</a>
			</li>
			<li><a href="#">Услуги</a>
				<ul>
