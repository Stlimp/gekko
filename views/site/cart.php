	...
	<form id="calculation_form" method="POST" action="index.php?r=site%2Forder" target="_blank">
		 <div class="total_price" style="width:80%;float:left;">
		 	...
		 	<div class="submit_form">
		 		<p style="padding:50px;">Ни одна товарная позиция не выбрана. Количество выбранных позиций в "МОЮ ГАЛЕРЕЮ" отображается в верхнем правом углу сайта. Для выбора интересующих вариантов продукции перейдите в раздел <a class="link_brown_color" href="index.php?r=product%2Findex">"ПРОДУКЦИЯ"</a></p>
		 	</div>
		 	<?php }else{ ?>
