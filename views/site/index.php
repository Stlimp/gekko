...
<!--             </div> -->
    ...
    и расцветок!</p>
        ...
        <div class="half">
            <div style="display:block;background-color:yellow;width:35%;height:100%;float:right"></div>
            <div style="display:block;background-color:green;width:35%;height:100%;float:right;margin-right:10px"></div>        
            <span style="float:right;padding-right:15px;">скачать <a href="">price</a></span>
        </div>
      </div>
    </div>
</div>
