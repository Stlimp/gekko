...
class Product extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['product_product_name', 'product_description','product_product_image', 'product_index_image', 'product_category_name', 'product_characteristics', 'product_regular_size', 'product_regular_thickness', 'product_regular_weight', 'product_regular_quantity', 'product_regular_repeatability', 'product_regular_calculation_size', 'product_price', 'product_regular_seamless_calculation_size', 'product_price_seamless'], 'required'],
            ...
            [['product_product_name',  'product_description','product_product_image', 'product_index_image', 'product_category_name', 'product_regular_size', 'product_regular_thickness', 'product_regular_quantity', 'product_regular_repeatability', 'product_angular_size', 'product_angular_thickness', 'product_angular_quantity', 'product_angular_repeatability'], 'string', 'max' => 255],
